...
const PasswordForm = ({ showToast }) => {
  ...
  return (
    <div className="bg-white rounded-xl p-6 md:p-8 border border-border shadow-sm">
      <h3 className="text-sm font-bold text-text-main mb-6 border-b border-border pb-4 uppercase tracking-widest text-red-500">
        {t('profile.security_credentials', 'Security Credentials')}
      </h3>

      <form onSubmit={handleUpdatePassword} className="max-w-md space-y-5">
        <div>
          <label className="block text-xs font-bold text-text-muted mb-2 uppercase tracking-wider">{t('profile.current_password', 'Current Password')}</label>
          <input
            type="password"
        ...
        <div>
          <label className="block text-xs font-bold text-text-muted mb-2 uppercase tracking-wider">{t('profile.new_password', 'New Password')}</label>
          <input
            type="password"
        ...
        <div>
          <label className="block text-xs font-bold text-text-muted mb-2 uppercase tracking-wider">{t('profile.confirm_password', 'Confirm New Password')}</label>
          <input
            type="password"
        ...
        <div>
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-2.5 bg-red-50 hover:bg-red-600 border border-red-100 hover:border-red-600 text-red-600 hover:text-white rounded-lg font-bold transition-colors disabled:opacity-70 w-full md:w-auto text-sm shadow-sm"
          >
